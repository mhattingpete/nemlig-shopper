...
| `pick_products` | Like `search_products`, but renders an **interactive picker** (MCP Apps) so you click to add — falls back to the same list where rendering isn't supported |
